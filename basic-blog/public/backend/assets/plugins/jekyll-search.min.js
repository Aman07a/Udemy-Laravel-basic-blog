                ...
                function FuzzySearchStrategy() {
                    ...
                    self.matches = function (string, crit) {
                        return "string" != typeof string
                            ...
                            : ((string = string.trim()),
                              !!string.match(
                                  createFuzzyRegExpFromString(crit)
                              ));
                    };
                }
            ...
            function (require, module) {
                function LiteralSearchStrategy() {
                    function doMatch(string, crit) {
                        return (
                            string.toLowerCase().indexOf(crit.toLowerCase()) >=
                            0
                        );
                    }
                    var self = this;
            ...
            function (require, module) {
                module.exports = function () {
                    function findMatches(store, crit, strategy) {
                        for (
                            var data = store.get(), i = 0;
                            i < data.length && matches.length < limit;
                            i++
                        )
                    ...
                    (self.setFuzzy = function (_fuzzy) {
                        ...
                        (self.search = function (data, crit) {
                            return crit
                                ? ((matches.length = 0),
                                  findMatches(data, crit, getSearchStrategy()))
                                : [];
                        });
                };
            },
                ...
                !(function (window) {
                    ...
                    function SimpleJekyllSearch() {
                        ...
                        function registerInput() {
                            opt.searchInput.addEventListener(
                                "keyup",
                                function (e) {
                        ...
                        function render(results) {
                            ...
                            for (var i = 0; i < results.length; i++)
                                appendToResultsContainer(
                                    templater.render(
                                        opt.searchResultTemplate,
                                        results[i]
                                    )
                                );
                        }
